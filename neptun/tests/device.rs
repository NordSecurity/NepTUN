...
impl Peer {
    ...
    fn gen_wg_conf(&self, local_key: &PublicKey, local_addr: &IpAddr, local_port: u16) -> String {
    ...
    fn start_in_container(&mut self, local_key: &PublicKey, local_addr: &IpAddr, local_port: u16) {
...
impl WGHandle {
    ...
    fn wg_set_peer(&self, key: &PublicKey, ep: &SocketAddr, allowed_ips: &[AllowedIp]) -> String {
